...
# Forzar UTF-8 en la salida (necesario en consolas Windows con codificación cp1252,
# para que los acentos y emojis de las respuestas se muestren correctamente)
try:
